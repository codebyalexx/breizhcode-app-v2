...
export const TicketsNavigation = () => {
    ...
    return (<header className={'relative w-full py-8 pb-16 px-5 bg-accent'}>
        <h1 className={'text-white text-3xl font-semibold'}>Mes titres</h1>
        <nav className={'absolute -bottom-5 left-5 right-5 bg-white rounded-lg'}>
            <ul className={'flex flex-row w-full'}>
                ...
                >
                    <Link href={'/tickets/active'} className={clsx('block p-3', ticketPage === 'active' ? 'font-semibold' : '')}>
                        Titres en cours
                    </Link>
                </li>
                <li
                ...
                >
                    <Link href={'/tickets/inventory'} className={clsx('block p-3', ticketPage === 'inventory' ? 'font-semibold' : '')}>
                        Titres restants
                    </Link>
                </li>
            </ul>
